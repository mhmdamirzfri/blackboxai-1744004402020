...
<head>
    ...
    <title>Landlord Dashboard | RentalSync</title>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-md p-6">
                ...
                <ul class="space-y-3">
                    <!-- PHP loop to display maintenance requests -->
                    <li class="flex justify-between">
                        <span>Leaky Faucet</span>
                        <span class="text-gray-500">Pending</span>
                    </li>
                    <li class="flex justify-between">
                        <span>Heating Issue</span>
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900">Tenant</p>
                            <p class="text-sm text-gray-500">Can you fix the heating?</p>
                        </div>
                    </div>
                </div>
                <div class="pt-3 mt-4 border-t border-gray-200">
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <button class="flex flex-col items-center justify-center p-3 bg-gray-100 rounded hover:bg-gray-200 transition">
                        ...
                        <span class="text-xs">Manage Tenants</span>
                    </button>
                    <button class="flex flex-col items-center justify-center p-3 bg-gray-100 rounded hover:bg-gray-200 transition">
